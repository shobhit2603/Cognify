  ...
  return (
    <section className="relative w-full py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-6xl mx-auto items-stretch">
        ...
        <div className="md:col-span-5 bg-[#151515] text-white rounded-lg p-8 sm:p-10 flex flex-col justify-between items-center text-center border border-white/10 relative overflow-hidden group min-h-85">
          <div className="absolute inset-0 bg-radial from-white/10 to-transparent opacity-30 pointer-events-none" />

          <div className="relative z-10 pt-4">
            <span className="text-sm font-bold uppercase tracking-widest text-osmo-lime">
              COGNIFY
            </span>
          </div>
          ...
          <div className="relative z-10 my-auto">
            ...
            <p className="font-caveat text-osmo-lime text-2xl mt-2">
        ...
        <div className="md:col-span-7 bg-osmo-purple text-white rounded-lg p-8 sm:p-12 flex flex-col justify-between relative overflow-hidden border border-osmo-purple/50 min-h-85">
          {/* Ambient light glow */}
          <div className="absolute -bottom-16 -right-16 w-56 h-56 rounded-lg bg-white/10 pointer-events-none" />
          ...
          <div className="relative z-10 pt-8 mt-6 border-t border-white/20 flex items-center gap-4 flex-wrap">
            <Link
              href="/auth"
              className="group/btn flex items-center gap-2.5 px-7 py-4 rounded-lg bg-osmo-lime text-black font-bold text-sm uppercase tracking-wider hover:bg-white transition-all duration-300 active:scale-95"
            >
            ...
            <Link
              href="/chat"
              className="px-6 py-4 rounded-lg bg-white/10 hover:bg-white/20 text-white font-bold text-sm uppercase tracking-wider transition-all duration-300 border border-white/10"
            >
