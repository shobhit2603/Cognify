  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-6 hero-badge">
        <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-none bg-black border border-black/10 text-xs font-semibold uppercase tracking-wider text-white">
